    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <form action="#" method="post" class="py-3 mx-3 needs-validation" id="register">
          ...
          <div class="mb-2">
            <label class="fw-semibold">SDT</label>
            <div class="input-group"><input name="phone" id="phone" type="phone" autocomplete="off" placeholder="Nhập sdt" class="form-control form-control-solid" value=""></div>
            <div class="invalid-feedback">Không được bỏ trống</div>
          </div>
          <div class="mb-2">
  ...
  function handleFormSubmission(event) {
    ...
    if (check) {
      ...
      $.ajax({
        ...
        type: 'POST',
        dataType: 'json',
        data: JSON.stringify({ "username": user_name, "password": pass_word, "phone": phone }),
        success: function (data, textStatus, xhr) {
          ...
          if (data.code == "02") {
            ...
            let alertErr = '<div class="alert alert-danger" id="error">SĐT đã tồn tại trên hệ thống.</div>';
            $("form#register").prepend(alertErr);
