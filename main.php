...
<head>
  ...
  <title>Việt Nam Z - Thế Giới Ninja School Online</title>
  ...
  <meta name="description" content="Tham gia trường học ninja để trở thành một nhẫn giả thực thụ">
                ...
                <div class="main">
                    <div class="text-center card">
                        <div class="card-body">
                            <div class="">
                                <a href="/">
                                    <img class="logo" alt="Logo" src="images/logoweb.gif" style="max-width: 220px;">
                                </a>
                            </div>
                            <div class="mt-3">
   ...
   <div class="modal-dialog">
      <div class="modal-content">
         <div class="modal-body">
            <div class="my-2">
               <div class="text-center"><a href="/"><img class="logo" alt="Logo" src="images/logoweb.gif" style="max-width: 250px;"></a></div>
            </div>
            <div class="text-center fw-semibold">
               <div id="noti" style="text-align: center;"></div>
               <div class="text-white text-center mb-2" id="waiting-times"></div>
               <div class="fs-6 mb-2" id="rainbowText">Thuê làm Web, Mod PB, Setup Sever</div>
               <div id="noti-active"></div>
               <span id="blinkingText" class="blink">Liên hệ ngay</span>
               <a class="w-100 fw-semibold" href="http://fb.com/hoank2prod">
                  <div class="mt-2 aci">
                     <button type="button" onclick="handleConfirm()" class="btn-rounded btn btn-primary btn-sm">Nhận báo giá</button>
                  </div>
               </a>
            </div>
         </div>
