...
<?php include('error.php'); ?>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (isset($_POST["edit"])) {
                ...
                $sqlSelectOld = "SELECT * FROM users WHERE id = $playersId";
                ...
                if (!empty($newValues)) {
                    if (isset($newValues['username'])) {
                        ...
                        $checkDuplicateName = "SELECT id FROM users WHERE username = '$newName' AND id != $playersId";
                    ...
                    if (isset($newValues['id'])) {
                        $newId = $newValues['id'];
                        $checkDuplicateId = "SELECT id FROM users WHERE id = $newId AND id != $playersId";
