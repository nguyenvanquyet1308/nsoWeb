...
<div class="card">
   ...
   <tbody>
      ...
      <tr class="fw-semibold">
         <td>Email</td>
         <td><?php echo maskEmail($row['email']); ?> (<a class="cursor-pointer text-primary" href="/change-phone-number">Thay đổi</a>)</td>        
      </tr>
   <?php
   ...
   ?>
        ...
        <tr class="fw-semibold">
            ...
            <td class="text-success fw-bold">
                <?php echo $row["kh"] == 1 ? "Đã kích hoạt" : "Chưa kích hoạt" ?>
            </td>
        </tr>
