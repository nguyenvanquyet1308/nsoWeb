...
?>
    ...
    <style>
        ...
        @keyframes blink {
            0%, 100% {
                color: red; /* Màu chữ khi không nhấp nháy */
            }
            50% {
                color: transparent; /* Màu chữ khi nhấp nháy */
            }
        }

        #warningModal .text-center span.blinking {
            animation: blink 0.5s infinite; /* Áp dụng animation với 0.5 giây mỗi chu kỳ và vô hạn lặp lại */
        }
    </style>
