    ...
    <form method="POST" class="form-signin" action="">
        ...
        <div class="text-center mt-3">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                $sql = "SELECT players.user_id, players.name, users.username, users.password, users.status, users.kh, players.xu, players.yen, users.coin, users.luong, users.isVIP, users.tongnap, users.ip_address, users.phone
                    FROM players
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        .tongnap-row td {
                            animation: flash-tongnap 1.23456789s infinite;
                        }
                    </style>
                    <table class='table'>
                        <tbody>
                            ...
                            <tr class='fw-semibold'>
                                <td>Trạng thái</td>
                                <td>" . getActivatedDescription($row["kh"]) . "</td>
                            </tr>
                            <tr class='separator'></tr>
                            ...
                            <tr class='fw-semibold'>
                                <td>IP</td>
                                <td>
                                    <span class='most-common-ip'>$mostCommonIP</span>
                                    <a class='cursor-pointer text-primary show-all-ip' style='display:$showAllLinkStyle;'>Hiển thị Tất cả</a>
