...
<div class="post-item d-flex align-items-center my-2">
       <div class="post-image"><img src="/images/avatar.png" alt="'.$item['title'].'"></div>
         ...
         <?php
            if (isset($_SESSION['username'])) {
                echo '<a class="fw-bold false" href="webshop">' . $configNapTien['SEVER']['tensv'] . ' Store</a>';
            } else {
                echo '<a class="fw-bold false" data-bs-toggle="modal" data-bs-target="#modalLogin" href="SEXTOP">' . $configNapTien['SEVER']['tensv'] . ' Store</a>';
            }
            ?>
   ...
   <div class="post-item d-flex align-items-center my-2">
       <div class="post-image"><img src="/images/avatar.png" alt="'.$item['title'].'"></div>
         ...
         <div class="text-muted font-weight-bold" style="color: #198754;">Đã đăng bởi: <span class="admin-highlight">Việt Nam Z</span></div>
         </div>
   </div>

<?php
$query_categories = "SELECT * FROM huong_dan";
...
<div class="mt-4">
    ...
    <?php
$sql = "SELECT content FROM gioithieu";
